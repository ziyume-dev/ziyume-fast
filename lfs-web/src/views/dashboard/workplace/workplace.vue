        ...
        <n-grid cols="2 s:1 m:1 l:2 xl:2 2xl:2" responsive="screen">
          <n-gi>
            <div class="flex items-center">
              ...
              <div>
                <p class="px-4 text-xl">早安，Bess Croft，开始您一天的工作吧！</p>
        ...
        >
          <div class="flex flex-wrap project-card">
            ...
            >
              ...
              <div class="flex mt-2 h-10 text-gray-400"> 开源，2023-05-11 </div>
            </n-card>
            <n-card
              size="small"
              class="cursor-pointer project-card-item ms:w-1/2 md:w-1/3"
            ...
            >
              ...
              <div class="flex mt-2 h-10 text-gray-400"> 学不动也要学，2023-05-11 </div>
            </n-card>
            <n-card
              size="small"
              class="cursor-pointer project-card-item ms:w-1/2 md:w-1/3"
            ...
            >
              ...
              <div class="flex mt-2 h-10 text-gray-400"> 撸码也是一种艺术 2023-05-11 </div>
            </n-card>
            <n-card
              size="small"
              class="cursor-pointer project-card-item ms:w-1/2 md:w-1/3"
            ...
            >
              ...
              <div class="flex mt-2 h-10 text-gray-400"> 铁粉君 2023-05-11。 </div>
            </n-card>
            <n-card
              size="small"
              class="cursor-pointer project-card-item ms:w-1/2 md:w-1/3"
            ...
            >
              ...
              <div class="flex mt-2 h-10 text-gray-400"> 技术牛 2023-05-11。 </div>
            </n-card>
            <n-card
              size="small"
              class="cursor-pointer project-card-item ms:w-1/2 md:w-1/3"
            ...
            >
              ...
              <div class="flex mt-2 h-10 text-gray-400"> 架构组 2023-05-11 </div>
            </n-card>
          </div>
        </n-card>
        ...
        >
          ...
          <n-list>
            <n-list-item>
              ...
              <n-thing title="Bess Croft 刚才把工作台页面随便写了一些，凑合能看了！">
                <template #description
                  ><p class="text-xs text-gray-500">2023-05-11 22:37:16</p></template
                >
              </n-thing>
            </n-list-item>
            <n-list-item>
              ...
              <n-thing title="Bess Croft 在 开源组 创建了项目 pisces-lfs">
                <template #description
                  ><p class="text-xs text-gray-500">2023-05-11 20:37:16</p></template
                >
              </n-thing>
            </n-list-item>
            <n-list-item>
