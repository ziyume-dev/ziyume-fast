  ...
  <div class="dashboard-container">
    ...
    <el-card class="box-card" style="margin-top: 30px" shadow="never">
      <el-table border v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="菜单级数" align="center" prop="level" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" label-width="100px">
        ...
        <el-form-item label="菜单名称" prop="icon">
          <el-input v-model="form.title" type="textarea" placeholder="请输入菜单名称" />
        </el-form-item>
        <el-form-item label="菜单排序" prop="email">
          <el-input v-model="form.sort" placeholder="请输入菜单排序值" />
        </el-form-item>
        <el-form-item label="前端名称" prop="phone">
          <el-input v-model="form.name" placeholder="请输入前端名称" />
        </el-form-item>
        <el-form-item label="路由地址" prop="nickName">
          <el-input v-model="form.path" placeholder="请输入路由地址" />
        </el-form-item>
        <el-form-item label="前端图标" prop="note">
          <el-input v-model="form.icon" type="textarea" placeholder="请输入前端图标" />
        </el-form-item>
        <el-form-item label="组件路径" prop="note">
          <el-input v-model="form.component" type="textarea" placeholder="请输入组件路径" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      adminMenu: Object.assign({}, defaultAdminMenu),
      // 遮罩层
      loading: true,
      // 选中数组
      ids: [],
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除权限管理模块菜单编号为"' + ids + '"的数据项?', "警告", {
